...
function Contact() {
  return (
    <div className="contact-container">
      <Seo
        title="Contact Us | AdTalk Events"
        description="Get in touch with AdTalk Event Solutions Inc. in Antipolo City, Rizal. Call, email, or message us for nationwide manpower deployment and brand activation services."
      ...
      <div className="contact-content">
        ...
        <div className="contact-grid">
          ...
          <div className="contact-column">
            ...
            <div className="contact-item">
              <div className="contact-icon"><Mail size={32} aria-hidden="true" /></div>
              <div className="contact-details">
                <h3>Email</h3>
            ...
            <div className="contact-item">
              <div className="contact-icon"><FacebookIcon width={32} height={32} /></div>
              <div className="contact-details">
                <h3>Follow Us</h3>
                <p>
                  <a href="https://www.facebook.com/profile.php?id=100064889586044" target="_blank" rel="noopener noreferrer">
                    Facebook
                  </a>
                </p>
              </div>
